...
// TODO: collisions --> 55 ???
// 
// TODO: log, parse session including flashing -- see end
//  scope
//  circuits for separating send/recv

// timing?  USB transfer --> 15 ms delays
// copy ICE closely
...
void openSerial() {
	...
	dcb.BaudRate = 144000;       // TODO: increase by changing divisor
	dcb.ByteSize = 8;
  dcb.StopBits = 0; // +1) /2
	dcb.fBinary = TRUE;
...
void SerialSync() {
  ...
  while (1) {
    switch (byte = SerialReadByte()) {
      ...
      case 0x55 : return;
      default : 
        printf("Got %X vs. 55 expected ", byte);
        rxFlush(-1);
        return;
    }
  }
...
int main() {
  ...
  // TODO: check other dWire code https://github.com/dwtk/dwtk/blob/master/debugwire/flash.go  
