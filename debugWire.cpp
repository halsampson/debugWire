...
void SerialSync() {  // after break, reset
  txFlush();
...
void setFastBaud() {  // TODO: debug ************
  ...
  // ?may need finer control of timing to work?   TODO
...
u8 regs[] = {
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE8, 0x97, 
  0x00, 0x01, 0x32, 0x00, 0x03, 0x00, 0x30, 0x00, 
...
int main(int argc, char *argv[]) { 
  ...
  unsigned char datapp[] = {
    ...
    0xD1, 0x00, 0x20, 
    0x46, 
    0xC2, 0x05, 0x20, // write top 2 regs
    0x57, 0x00, 
  
    0xD1, 0x00, 0x03, 
    0xD0, 0x00, 0x01, 
	  0x46, 
    0xC2, 0x04, 0x20, //  write SRAM
    0x00, 
  };
  
  DwSend(datapp, sizeof datapp);
